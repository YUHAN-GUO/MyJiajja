...
public class TabMenu extends LinearLayout {
    ...
    private onSelecterListener mSelecterListener;
...
//        int textColor1 = ContextCompat.getColor(getContext(), R.color.colorBlack);
//        int textColor2 = ContextCompat.getColor(getContext(), R.color.colorPrimary);
        for (int i = 0; i < ITEM_COUNT_MAX; i++) {
            if (i == this.which) {
    ...
    public TabMenu setupWithViewPager(ViewPager viewPager) {
        ...
        this.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            ...
            public void onClick(View view, int pos) {
                if (mSelecterListener != null) {
                    mSelecterListener.onSelecter(pos);
                }
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (mSelecterListener != null) {
//                    mSelecterListener.onSelecter(position);
                }
    ...
    public void setmSelecterListener(onSelecterListener mSelecterListener) {
        this.mSelecterListener = mSelecterListener;
    }
