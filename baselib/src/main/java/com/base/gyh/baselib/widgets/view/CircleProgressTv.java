...
public class CircleProgressTv extends AppCompatTextView {
    ...
    public CircleProgressTv(Context context) {
        this(context, null);
    }

    public CircleProgressTv(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleProgressTv(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.CircleProgressTv);
        if (typedArray.hasValue(R.styleable.CircleProgressTv_in_circle_color)) {
            inCircleColors = typedArray.getColorStateList(R.styleable.CircleProgressTv_in_circle_color);
            progressLineColor = typedArray.getColor(R.styleable.CircleProgressTv_out_ring_color, ContextCompat.getColor(getContext(),R.color.colorPrimary));
        } else {
